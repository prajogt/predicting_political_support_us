...
```{r}
#| label: fig-modelsummarycultural
#| fig-cap: "Explaining whether a voter supported Biden or Trump in 2020 given their gender, age, race, and religion"
#| message: false
#| warning: false
#| echo: false
...
```{r}
#| label: fig-modelsummaryimportances
#| fig-cap: "Explaining whether a voter supported Biden or Trump in 2020 given their education, household gun ownership, and student load status."
#| message: false
#| warning: false
#| echo: false
...
#| message: false
#| echo: false
#| label: tbl-conf_cultural
#| tbl-cap: "Cultural Model 90% Confidence Intervals"
